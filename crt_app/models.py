...
class Class(models.Model):
    ...
    year=models.IntegerField(choices=SEMESTER_CHOICES)
    class Meta:
...
class Approval(models.Model):
    ...
    approval_type = models.CharField(max_length=20, choices=[('new_stu_account', 'stu_account')], default='new_stu_account')
